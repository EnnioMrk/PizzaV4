...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const passwordMsgWrapper = document.getElementById('passwordMsgWrapper');
    ...
    passwordInputEl.addEventListener('input', () => {
        ...
        if (passwordInputEl.value.length == 0)
            passwordSuggestion.innerHTML = '';
        if (passwordInputEl.value.length > 0) {
            passwordMsgWrapper.classList.remove('h-0');
            passwordMsgWrapper.classList.add('h-min');
            ...
            passwordMsgWrapper.classList.add('h-0');
            passwordMsgWrapper.classList.remove('h-min');
        }
        styles.set(
            'psw',
            `#passwordInput + label::after {width: ${
